...
正常 JSON 日志应包含 `"modelVersion":"special-kongs-v4"`、`"wallRemaining":83` 和 `"totalTiles":136`；`handTileCounts` 中应恰好一家14张、三家13张。日志不会记录具体手牌或暗杠牌面。
...
命令退出码为0，并返回 `"modelVersion":"special-kongs-v4"`、`"gamePhase":"playing"`、`"wallAfterFirstDiscard":82`、`"wallAfterSecondDiscard":81`、`"discardCountAfterSecondTurn":2`，以及两个静态美术资源的正确 MIME/字节数，表示特殊杠模型、最小回合和横屏牌桌资源的公网流程通过。
